      ...
      <div className="max-w-5xl mx-auto">
        ...
        <body>
          ...
          <div className="music-play hidden">
            ...
            <img className="music-play-img" src="large/dkc_snes_island.png" />
